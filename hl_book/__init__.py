...
def _candidate_paths() -> list[Path]:
    ...
    env_path = os.environ.get("HL_BOOK_NATIVE_PATH") or os.environ.get("HL_PY_NATIVE_PATH")
...
def _load_native() -> ModuleType:
    module_name = "hl_book._hl_book_native"
    ...
    raise ImportError(
        "could not locate hl_book native extension; build it with "
        "`cargo build -p hl_book --release` or set HL_BOOK_NATIVE_PATH.\n"
        f"Searched:\n{searched_text}"
    )
